...
//             <Stethoscope size={13} />
//             <span>{t("nav.find_doctor") || "Find a Doctor"}</span>
//           </div>
...
//                   </div>
//                   <div className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/65 to-transparent px-4 pt-8 pb-3">
...
//                   <h3 className="mb-1 text-[15px] leading-snug font-bold text-neutral-900">
//                     {doctor.name}
//                   </h3>
//                   <p className="mb-1 flex items-center gap-1.5 text-[11px] text-neutral-500">
//                     <Award size={11} className="text-[var(--brand-primary)]" />
//                     {doctor.experience} years experience
//                   </p>
//                   <p className="mb-5 flex items-center gap-1.5 text-[11px] text-neutral-500">
//                     <MapPin size={11} className="text-[var(--brand-primary)]" />
//                     Karuna Hospital, Saharanpur
//                   </p>
//                   <button
//                     onClick={() => setSelectedDoctor(doctor)}
//                     className="mt-auto flex w-full items-center justify-center gap-2 rounded-xl bg-blue-50 px-4 py-2.5 text-sm font-semibold text-[var(--brand-primary)] transition-all duration-200 hover:bg-[var(--brand-primary)] hover:text-white"
//                   >
//                     View Profile
...
//               className="absolute top-4 right-4 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-white transition hover:bg-white/35"
...
//             {/* Header */}
//             <div className="bg-gradient-to-br from-[#0C447C] to-[#185FA5] px-7 py-8">
//               <div className="flex items-end gap-5">
//                 <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl border-2 border-white/30 bg-blue-200">
...
//                       <Stethoscope size={32} className="text-white/60" />
//                     </div>
//                   )}
//                 </div>
//                 <div>
...
//             {/* Stats */}
//             <div className="grid grid-cols-3 gap-3 bg-neutral-50 px-7 py-5">
//               <div className="rounded-xl border border-neutral-100 bg-white p-3 text-center shadow-sm">
//                 <Award
//                   size={15}
//                   className="mx-auto mb-1 text-[var(--brand-primary)]"
//                 />
//                 <p className="text-base font-bold text-neutral-900">
//                   {selectedDoctor.experience}+
//                 </p>
//                 <p className="text-[11px] text-neutral-500">Years exp.</p>
//               </div>
//               <div className="rounded-xl border border-neutral-100 bg-white p-3 text-center shadow-sm">
//                 <Users
//                   size={15}
//                   className="mx-auto mb-1 text-[var(--brand-primary)]"
//                 />
//                 <p className="text-base font-bold text-neutral-900">500+</p>
//                 <p className="text-[11px] text-neutral-500">Patients</p>
//               </div>
//               <div className="rounded-xl border border-neutral-100 bg-white p-3 text-center shadow-sm">
//                 <Stethoscope
//                   size={15}
//                   className="mx-auto mb-1 text-[var(--brand-primary)]"
//                 />
//                 <p className="text-base font-bold text-neutral-900">Expert</p>
//                 <p className="text-[11px] text-neutral-500">Specialist</p>
//               </div>
//             </div>
...
//                 <Link
//                   href="/contact"
//                   className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[var(--brand-primary)] px-4 py-3 text-sm font-semibold text-white transition hover:opacity-90"
//                 >
//                   <Calendar size={15} />
//                   Book Appointment
//                 </Link>
...
//                   className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm font-semibold text-neutral-700 transition hover:bg-neutral-100"
//                 >
//                   Full Profile
