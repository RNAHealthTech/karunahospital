...
//                 id="hero-specialities-btn"
//               >
//                 {t("hero.cta.specialities")}
//                 <ArrowRight size={16} aria-hidden="true" />
//               </Link>
//             </div>
//             <div className="hero__trust">
//               {["NABH Accredited", "Est. 2011", "24/7 Emergency"].map(
//                 (item) => (
...
//                 <Heart size={32} className="hero__heart-icon" />
//               </div>
//               <div className="hero__card-text">
//                 <span className="hero__card-num">10,000+</span>
//                 <span className="hero__card-label">Successful Surgeries</span>
//               </div>
//             </div>
//             <div className="hero__card hero__card--floating hero__card--top">
//               <Brain size={20} />
//               <span>Expert Neurologists</span>
//             </div>
//             <div className="hero__card hero__card--floating hero__card--bottom">
//               <Shield size={20} />
