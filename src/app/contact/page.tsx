...
export default function ContactForm() {
  ...
  // ✅ Universal WhatsApp link (works on mobile + desktop)
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=${prefillMessage}`;

  // ✅ Fallback link if wa.me doesn't work
  const whatsappFallback = `https://api.whatsapp.com/send?phone=${whatsappNumber}&text=${prefillMessage}`;
  ...
  // ✅ Handle WhatsApp click with fallback
  ...
  <section className="hero hero--internal">
        ...
        <div className="hero__inner">
          ...
          <p className="hero__subtitle">
             Reach out for appointments, emergencies, or general inquiries. Our care team is here to assist you 24/7. We look forward to hearing from you!
          </p>
        </div>
      </section>
...
>
  ...
  <div>
    ...
    >
      We are here to assist you 24/7. Reach out for appointments, emergencies,
    ...
    <div style={{ display: "grid", gap: "1rem" }}>
      ...
      {/* Email */}
      <div className="spec-card" style={{ padding: "1.2rem" }}>
        <h4 style={{ fontWeight: 600 }}>✉️ Email</h4>
        <p style={{ color: "var(--neutral-600)", fontSize: "0.9rem" }}>
      ...
      >
        <h4 style={{ fontWeight: 600, color: "red" }}>🚨 Emergency</h4>
  ...
  {/* ================= RIGHT SIDE  ================= */}
    ...
    >
      ...
      >
        ...
        >
          Fill out the form below or message us directly on WhatsApp. Our care
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: "1.25rem" }}>
          ...
          >
            Subject <span style={{ color: "var(--brand-accent)" }}>*</span>
          </label>
          <select
            id="subject"
            name="subject"
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          >
            Your Message <span style={{ color: "var(--brand-accent)" }}>*</span>
          </label>
          <textarea
            id="message"
            name="message"
        ...
        >
          ...
          >
            ...
            <span>
              Your information is secure. We only use it to respond to your
              inquiry.
              <a
                href="/privacy"
                style={{
        ...
        >
          {/* ✅ Official WhatsApp Icon (simplified) */}
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
